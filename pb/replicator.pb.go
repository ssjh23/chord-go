...
func (x *ReplicateDataRequest) GetData() map[string]string {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ReplicateDataResponse) GetResp() string {
	if x != nil {
		return x.Resp
	}
	return ""
...
var file_replicator_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x87, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x70, 0x6c, 0x69,
	...
	0x70, 0x62, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61,
	...
	0x22, 0x2b, 0x0a, 0x15, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74,
	0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x65, 0x73,
	0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x65, 0x73, 0x70, 0x42, 0x1f, 0x5a,
...
var file_replicator_proto_goTypes = []interface{}{
	(*ReplicateDataRequest)(nil),  // 0: pb.ReplicateDataRequest
	(*ReplicateDataResponse)(nil), // 1: pb.ReplicateDataResponse
	nil,                           // 2: pb.ReplicateDataRequest.DataEntry
}
var file_replicator_proto_depIdxs = []int32{
	2, // 0: pb.ReplicateDataRequest.data:type_name -> pb.ReplicateDataRequest.DataEntry
...
func file_replicator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_replicator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicateDataRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_replicator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicateDataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
