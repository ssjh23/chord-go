...
var file_service_chord_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc4, 0x03,
...
var file_service_chord_proto_goTypes = []interface{}{
	...
	(*ClientResponse)(nil),             // 9: pb.ClientResponse
	(*InsertKeyValuePairResponse)(nil), // 10: pb.InsertKeyValuePairResponse
	(*GetValueFromKeyResponse)(nil),    // 11: pb.GetValueFromKeyResponse
}
var file_service_chord_proto_depIdxs = []int32{
	...
	8,  // 8: pb.Chord.FindSuccessor:output_type -> pb.FindSuccessorResponse
	9,  // 9: pb.Chord.ClientRequestHandler:output_type -> pb.ClientResponse
	10, // 10: pb.Chord.InsertKeyValuePair:output_type -> pb.InsertKeyValuePairResponse
	11, // 11: pb.Chord.GetValueFromKey:output_type -> pb.GetValueFromKeyResponse
