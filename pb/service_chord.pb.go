...
var file_service_chord_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92, 0x07,
	...
	0x00, 0x12, 0x4f, 0x0a, 0x10, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x65, 0x64, 0x65, 0x63,
	0x65, 0x73, 0x73, 0x6f, 0x72, 0x12, 0x1b, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x50, 0x72, 0x65, 0x64, 0x65, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x65,
...
var file_service_chord_proto_goTypes = []interface{}{
	...
	(*CheckPredecessorRequest)(nil),    // 12: pb.CheckPredecessorRequest
	(*GetChordNodeResponse)(nil),       // 13: pb.GetChordNodeResponse
	(*GetResponseToClient)(nil),        // 14: pb.GetResponseToClient
	(*FindSuccessorResponse)(nil),      // 15: pb.FindSuccessorResponse
	(*ClientResponse)(nil),             // 16: pb.ClientResponse
	(*InsertKeyValuePairResponse)(nil), // 17: pb.InsertKeyValuePairResponse
	(*GetValueFromKeyResponse)(nil),    // 18: pb.GetValueFromKeyResponse
	(*CreateRingResponse)(nil),         // 19: pb.CreateRingResponse
	(*JoinRingResponse)(nil),           // 20: pb.JoinRingResponse
	(*StabilizeResponse)(nil),          // 21: pb.StabilizeResponse
	(*GetPredecessorResponse)(nil),     // 22: pb.GetPredecessorResponse
	(*NotifyResponse)(nil),             // 23: pb.NotifyResponse
	(*FixFingerTableResponse)(nil),     // 24: pb.FixFingerTableResponse
	(*CheckPredecessorResponse)(nil),   // 25: pb.CheckPredecessorResponse
}
var file_service_chord_proto_depIdxs = []int32{
	...
	12, // 12: pb.Chord.CheckPredecessor:input_type -> pb.CheckPredecessorRequest
	13, // 13: pb.Chord.GetChordNode:output_type -> pb.GetChordNodeResponse
	14, // 14: pb.Chord.RequestFromClient:output_type -> pb.GetResponseToClient
	15, // 15: pb.Chord.FindSuccessor:output_type -> pb.FindSuccessorResponse
	16, // 16: pb.Chord.ClientRequestHandler:output_type -> pb.ClientResponse
	17, // 17: pb.Chord.InsertKeyValuePair:output_type -> pb.InsertKeyValuePairResponse
	18, // 18: pb.Chord.GetValueFromKey:output_type -> pb.GetValueFromKeyResponse
	19, // 19: pb.Chord.CreateRing:output_type -> pb.CreateRingResponse
	20, // 20: pb.Chord.JoinRing:output_type -> pb.JoinRingResponse
	21, // 21: pb.Chord.Stabilize:output_type -> pb.StabilizeResponse
	22, // 22: pb.Chord.GetPredecessor:output_type -> pb.GetPredecessorResponse
	23, // 23: pb.Chord.Notify:output_type -> pb.NotifyResponse
	24, // 24: pb.Chord.FixFingerTable:output_type -> pb.FixFingerTableResponse
	25, // 25: pb.Chord.CheckPredecessor:output_type -> pb.CheckPredecessorResponse
