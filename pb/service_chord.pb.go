...
var file_service_chord_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9b, 0x03, 0x0a, 0x05, 0x43, 0x68,
	...
	0x72, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xde, 0x01,
	...
	0x73, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1f,
...
var file_service_chord_proto_goTypes = []interface{}{
	...
	(*JoinNodeRequest)(nil),        // 4: pb.JoinNodeRequest
	(*LeaveNodeRequest)(nil),       // 5: pb.LeaveNodeRequest
	(*GetChordNodeResponse)(nil),   // 6: pb.GetChordNodeResponse
	(*GetResponseToClient)(nil),    // 7: pb.GetResponseToClient
	(*GetSuccessorResponse)(nil),   // 8: pb.GetSuccessorResponse
	(*GetPredecessorResponse)(nil), // 9: pb.GetPredecessorResponse
	(*JoinNodeResponse)(nil),       // 10: pb.JoinNodeResponse
	(*LeaveNodeResponse)(nil),      // 11: pb.LeaveNodeResponse
	(*GetChordNodeRequest)(nil),   // 0: pb.GetChordNodeRequest
	(*GetRequestFromClient)(nil),  // 1: pb.GetRequestFromClient
	(*FindSuccessorRequest)(nil),  // 2: pb.FindSuccessorRequest
	(*GetChordNodeResponse)(nil),  // 3: pb.GetChordNodeResponse
	(*GetResponseToClient)(nil),   // 4: pb.GetResponseToClient
	(*FindSuccessorResponse)(nil), // 5: pb.FindSuccessorResponse
}
var file_service_chord_proto_depIdxs = []int32{
	...
	4,  // 4: pb.Chord.JoinNode:input_type -> pb.JoinNodeRequest
	5,  // 5: pb.Chord.LeaveNode:input_type -> pb.LeaveNodeRequest
	6,  // 6: pb.Chord.GetChordNode:output_type -> pb.GetChordNodeResponse
	7,  // 7: pb.Chord.RequestFromClient:output_type -> pb.GetResponseToClient
	8,  // 8: pb.Chord.GetSuccessor:output_type -> pb.GetSuccessorResponse
	9,  // 9: pb.Chord.GetPredecessor:output_type -> pb.GetPredecessorResponse
	10, // 10: pb.Chord.JoinNode:output_type -> pb.JoinNodeResponse
	11, // 11: pb.Chord.LeaveNode:output_type -> pb.LeaveNodeResponse
	...
	3, // 3: pb.Chord.GetChordNode:output_type -> pb.GetChordNodeResponse
	4, // 4: pb.Chord.RequestFromClient:output_type -> pb.GetResponseToClient
	5, // 5: pb.Chord.FindSuccessor:output_type -> pb.FindSuccessorResponse
