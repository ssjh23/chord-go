...
var file_service_chord_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc1, 0x06,
	...
	0x73, 0x73, 0x6a, 0x68, 0x32, 0x33, 0x2f, 0x63, 0x68, 0x6f, 0x72, 0x64, 0x2d, 0x67, 0x6f, 0x2f,
...
var file_service_chord_proto_goTypes = []interface{}{
	...
	(*GetChordNodeResponse)(nil),       // 12: pb.GetChordNodeResponse
	(*GetResponseToClient)(nil),        // 13: pb.GetResponseToClient
	(*FindSuccessorResponse)(nil),      // 14: pb.FindSuccessorResponse
	(*ClientResponse)(nil),             // 15: pb.ClientResponse
	(*InsertKeyValuePairResponse)(nil), // 16: pb.InsertKeyValuePairResponse
	(*GetValueFromKeyResponse)(nil),    // 17: pb.GetValueFromKeyResponse
	(*CreateRingResponse)(nil),         // 18: pb.CreateRingResponse
	(*JoinRingResponse)(nil),           // 19: pb.JoinRingResponse
	(*StabilizeResponse)(nil),          // 20: pb.StabilizeResponse
	(*GetPredecessorResponse)(nil),     // 21: pb.GetPredecessorResponse
	(*NotifyResponse)(nil),             // 22: pb.NotifyResponse
	(*FixFingerTableResponse)(nil),     // 23: pb.FixFingerTableResponse
}
var file_service_chord_proto_depIdxs = []int32{
	...
	12, // 12: pb.Chord.GetChordNode:output_type -> pb.GetChordNodeResponse
	13, // 13: pb.Chord.RequestFromClient:output_type -> pb.GetResponseToClient
	14, // 14: pb.Chord.FindSuccessor:output_type -> pb.FindSuccessorResponse
	15, // 15: pb.Chord.ClientRequestHandler:output_type -> pb.ClientResponse
	16, // 16: pb.Chord.InsertKeyValuePair:output_type -> pb.InsertKeyValuePairResponse
	17, // 17: pb.Chord.GetValueFromKey:output_type -> pb.GetValueFromKeyResponse
	18, // 18: pb.Chord.CreateRing:output_type -> pb.CreateRingResponse
	19, // 19: pb.Chord.JoinRing:output_type -> pb.JoinRingResponse
	20, // 20: pb.Chord.Stabilize:output_type -> pb.StabilizeResponse
	21, // 21: pb.Chord.GetPredecessor:output_type -> pb.GetPredecessorResponse
	22, // 22: pb.Chord.Notify:output_type -> pb.NotifyResponse
	23, // 23: pb.Chord.FixFingerTable:output_type -> pb.FixFingerTableResponse
