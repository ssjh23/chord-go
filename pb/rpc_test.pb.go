...
var file_rpc_test_proto_goTypes = []interface{}{
	...
	(*CheckPredecessorRequest)(nil),  // 14: pb.CheckPredecessorRequest
	(*CheckPredecessorResponse)(nil), // 15: pb.CheckPredecessorResponse
}
...
func file_rpc_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_test_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckPredecessorRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_test_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckPredecessorResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
